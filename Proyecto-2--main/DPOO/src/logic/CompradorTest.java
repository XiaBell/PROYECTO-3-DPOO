...
public class CompradorTest {
    ...
    public void setUp() {
        ...
        comprador = new Comprador("Test", "Usuario", 12345678, "testuser", "testpass", 30012345, 5000, "Usuario", "01-01-2024", true);
        // Inicializa una pieza de prueba, en este caso, una Escultura
        pieza = new Escultura(12, 12, 12, "cobre");
    }
    ...
    public void testConsignarPieza() {
        ...
        assertTrue(piezas_persistence.add_info(pieza.infoconsignarpieza()));
    }
}
